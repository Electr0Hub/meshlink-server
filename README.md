...
Part of the [MeshLink](https://github.com/Electr0Hub/meshlink-station) home mesh network. The bridge ESP32 runs `meshlink-station` firmware in relay-only mode, printing received mesh traffic over USB serial.
